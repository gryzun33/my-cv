  ...
  return (
    <section className="about-section">
      ...
      <p>
        ...
        communication skills, attention to detail. In my previous life I worked as an electrical
        design engineer for power supply and lighting, but during maternity leave I decided to try
